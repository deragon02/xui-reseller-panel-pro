...
اتصال واقعی ساخت Client از طریق API در این نسخه فعال است، اما نصب موفق پنل به‌معنای نصب یا تغییر پنل 3x-ui نیست. قبل از Production باید API Docs نسخه دقیق 3x-ui، نوع Token، TLS و سیاست مالکیت را با سرور واقعی بررسی و تست کنید.
